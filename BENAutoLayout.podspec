Pod::Spec.new do |s|
  ...
  s.version      = "0.1.0"
  s.summary      = "Some convenient UIView category methods for quickly adding autolayout constraints"
  ...
  s.platform     = :ios, 6.0
  s.source       = { :git => "https://github.com/benpackard/BENAutoLayout.git", :tag => "0.1.0" }
  s.source_files  = '*.{h,m}'
  s.requires_arc = true
end